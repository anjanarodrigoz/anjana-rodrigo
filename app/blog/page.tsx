...
const blogPosts = [
  {
    ...
    excerpt: "Managing multiple Flutter apps with shared packages across separate repos is painful. Here's how to set up a monorepo with Melos — and why I'm migrating my own projects to this structure.",
    date: "2024-02-20",
    readTime: "18 min read",
    tags: ["Flutter", "DevOps", "Architecture"],
    image: "/blog/flutter-monorepo.jpg",
  },
  {
    slug: "building-zomoto-pos",
    title: "Building Zomoto: A Full-Stack Restaurant POS System with Flutter",
    excerpt: "How I built my first Flutter application — a restaurant POS system now running in 3 restaurants in Sri Lanka — and the architecture decisions, challenges, and lessons I learned along the way.",
    date: "2024-02-01",
    readTime: "15 min read",
    tags: ["Flutter", "Architecture", "Case Study", "Firebase"],
    image: "/blog/zomoto-pos.jpg",
  },
  {
    slug: "from-mining-to-code",
    title: "From Mining Engineer to Software Developer: My Journey",
    excerpt: "From childhood programming to University of Moratuwa, native Android to Flutter, mining internship apps to full-stack development — how I followed my passion through an unconventional path.",
    date: "2024-01-15",
    readTime: "8 min read",
  ...
  {
    slug: "flutter-flavors-guide",
    title: "Flutter Flavors: Because Your App Has Multiple Personalities",
    excerpt: "Stop manually changing API URLs between dev and production. Learn how to set up Flutter Flavors to run multiple versions of your app from one codebase — with different configs, icons, and names.",
    date: "2024-02-10",
    readTime: "14 min read",
    tags: ["Flutter", "DevOps", "Tutorial"],
    image: "/blog/flutter-flavors.jpg",
  },
  {
