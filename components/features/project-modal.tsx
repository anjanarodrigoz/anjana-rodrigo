    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-6xl max-h-[90vh] overflow-y-auto rounded-2xl border-2 border-border shadow-2xl scrollbar-thin bg-background"
        ...
        >
          ...
          <div className="p-8">
            ...
            {project.stats && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {Object.entries(project.stats).map(([key, value]) => (
                  <div key={key} className="glass p-4 rounded-xl text-center border border-border bg-emerald-500/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="glass p-6 rounded-xl border-l-4 border-amber-500 bg-amber-500/5">
                <h3 className="text-xl font-bold mb-3 text-amber-600 dark:text-amber-500">The Problem</h3>
                <p className="text-foreground/80 leading-relaxed">
                  {project.problem}
                </p>
              </div>
              <div className="glass p-6 rounded-xl border-l-4 border-emerald-500 bg-emerald-500/5">
                <h3 className="text-xl font-bold mb-3 text-emerald-600 dark:text-emerald-500">The Solution</h3>
                <p className="text-foreground/80 leading-relaxed">
                  {project.solution}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {project.features.map((feature, index) => (
                  <motion.div
                    ...
                    className="flex items-start gap-3 glass p-4 rounded-lg border border-border bg-background"
                  >
